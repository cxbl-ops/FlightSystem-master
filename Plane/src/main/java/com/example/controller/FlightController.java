...
public class FlightController {
    ...
    public ResponseResult editFlight(@RequestBody Flight flight) {
       var res = flightService.editFlight(flight);
    ...
    public ResponseResult deleteFlightById(@RequestBody Flight flight)  {
        ...
        return new ResponseResult<>(200, flightService.deleteFlightById(flight.getId()));
...
//
        var getResult = api.LocalSign("Flight", "0xf86664e501d4a7e9927db3499e935f1c33d6637c", "addFlight", _flightInfo,
