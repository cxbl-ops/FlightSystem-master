<template>
  <el-main class="main-center">
    ...
    <div class="block" style="margin-top: 50px">
      <el-pagination background :current-page.sync="queryParam.currentPage" :page-size="queryParam.pageSize" @loadData="loadData" layout="prev, pager, next" @next-click="handleNextClick" @prev-click="handlePrevClick" :total="queryParam.totalRecords"></el-pagination>
    </div>
...
<script>
import { handlePrevClick, handleNextClick, loadData, handleFocus, ret, handleAddFlight, editFlight, saveFlightEdit, handleDeleteFlightById, deleteFlight, getCountry, getChildProject } from '@/services/FlightMethods.js';
